...
import { htmlElementAsString, Severity } from 'frontend-monitor-utils';
import { EventTypes, BreadCrumbTypes } from 'frontend-monitor-shared';
import { breadcrumb, handleConsole } from 'frontend-monitor-core';
