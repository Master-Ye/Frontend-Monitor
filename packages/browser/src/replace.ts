...
import { EMethods, MonitorHttp, MonitorXMLHttpRequest } from 'frontend-monitor-types';
import { voidFun, EventTypes, HttpTypes, HttpCodes } from 'frontend-monitor-shared';
