import { BreadCrumbTypes, ErrorTypes, globalVar } from 'frontend-monitor-shared';
import {
  getLocationHref,
  getTimestamp,
  Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'frontend-monitor-types';
